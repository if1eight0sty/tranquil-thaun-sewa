  ...
  return (
    ...
    >
      ...
      <div className="transition duration-200 group-hover/bento:translate-x-2">
        ...
        <button className="relative inline-block p-px text-xs font-semibold leading-6 text-white no-underline rounded-full shadow-2xl cursor-pointer bg-slate-700 group shadow-zinc-900">
